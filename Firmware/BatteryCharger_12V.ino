...
#define DCDC_MAX_POWER_W               350L		// Maximum continuous DC/DC output power at normal temperature.
...
#define LOW_POWER_INPUT_MAX_mA        3000L		// Maximum current the low-power source may supply without overload.
#define MID_POWER_INPUT_MAX_mA       10000L		// Maximum current the mid-power source may supply without overload.
#define HIGH_POWER_INPUT_MAX_mA      30000L		// Maximum current the high-power source may supply without overload.
...
#define ENABLE_FLOAT                      1		// Enables 13.2V maintenance charging after a completed full-charge cycle.
#define BATTERY_RESTART_mV            12600L		// Starts a new full-charge cycle when the rested battery falls to this voltage.
#define BATTERY_ABSORPTION_mV         14200L		// Voltage maintained during absorption charging.
#define BATTERY_FLOAT_mV              13200L		// Voltage maintained while float charging is enabled.
#define BATTERY_FULL_CURRENT_mA         100L		// End-current criterion used after the minimum absorption time.
...
#define BATTERY_MAX_CHARGE_CURRENT_mA 30000L		// User battery-current limit; the 350W DC/DC power limit always has priority.
...
#define DCDC_TEST_MIN_OUTPUT_mV         10000L		// Minimum plausible DC/DC output after converter startup.
#define DCDC_TEST_RAISE_OFFSET_mV          80L		// Test level above battery voltage used to prove converter response.
#define DCDC_TEST_RISE_MIN_mV              40L		// Minimum measured rise required for a successful function test.
...
#define DCDC_CONNECT_OFFSET_mV               30L		// DC/DC target above battery voltage when the charge switch closes.
...
#define DCDC_DERATING_START_C                65		// Full 350W is allowed up to this FET/coil temperature.
#define DCDC_DERATING_70C_POWER_W           260L		// Preliminary test value for allowed power at 70C.
#define DCDC_DERATING_75C_POWER_W           175L		// Preliminary test value for allowed power at 75C.
#define DCDC_DERATING_80C_POWER_W           100L		// Preliminary test value for allowed power at 80C.
#define DCDC_SHUTDOWN_TEMP_C                 85		// Charging stops when either FET or coil reaches this temperature.
#define DCDC_RESTART_TEMP_C                  55		// Charging may restart after thermal shutdown when both sensors are below this value.
...
#define INA238_CORR_HIGH_POWER_PERMILLE   2000L		// Input current correction. Car battery 120Ah: same calibration method.
#define INA238_CORR_MID_POWER_PERMILLE  2000L		// Input current correction. Car battery 120Ah: same calibration method.
#define INA238_CORR_LOW_POWER_PERMILLE   2000L		// Input current correction. Car battery 120Ah: same calibration method.
...
void setup()
{
	...
	DBG_PRINTLN(F("BatteryCharger_12V"));
